...
#ifndef JIMMY_SWIFT_H
#define JIMMY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Jimmy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC5Jimmy18AudioPlayerService")
...
SWIFT_CLASS("_TtC5Jimmy14CarPlayManager")
...
@class CPWindow;
SWIFT_CLASS("_TtC5Jimmy20CarPlaySceneDelegate")
...
@class NSXMLParser;
SWIFT_CLASS("_TtC5Jimmy10OPMLParser")
...
SWIFT_CLASS("_TtC5Jimmy9RSSParser")
...
@class WCSession;
SWIFT_CLASS("_TtC5Jimmy24WatchConnectivityService")
@interface WatchConnectivityService : NSObject <WCSessionDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
