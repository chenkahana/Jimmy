...
extension DeveloperToolsSupport.ColorResource {
    ...
    static let surfaceHighlighted = DeveloperToolsSupport.ColorResource(name: "SurfaceHighlighted", bundle: resourceBundle)
...
extension AppKit.NSColor {
    ...
    /// The "SurfaceHighlighted" asset catalog color.
    static var surfaceHighlighted: AppKit.NSColor {
#if !targetEnvironment(macCatalyst)
        .init(resource: .surfaceHighlighted)
#else
        .init()
#endif
    }
...
extension UIKit.UIColor {
    ...
    /// The "SurfaceHighlighted" asset catalog color.
    static var surfaceHighlighted: UIKit.UIColor {
#if !os(watchOS)
        .init(resource: .surfaceHighlighted)
#else
        .init()
...
extension SwiftUI.Color {
    ...
    /// The "SurfaceHighlighted" asset catalog color.
    static var surfaceHighlighted: SwiftUI.Color { .init(.surfaceHighlighted) }
